...
% TODO: can also reference grant proposals at ged.msu.edu/interests.html.
...
utility and correctness up to this point.  Our goal was to optimize
...
% @Eric -- do you have specific numbers to put in this next paragraph?
...
TAU needs to be configured to support various profiling activitites.
...
% @Eric -- i wasn't sure of how to address the set of comments that
% Colin made here. --ctb
...
% @Eric see Colin's comments re aggressive optimization.  I think it's
% fine (it is a standard term, right?) but may need to be explained a bit
% more.  I'm not sure how to do it.
